...
这个任务中，有两个物体被叠放在一起，增加了处理的难度。因此，这个任务被分为两部分，一部分专注于长方体的提取，另一部分专注于三棱柱的提取。

#### 3.6.1 Task5-1

这里解决的是长方体的提取。完成这一任务的步骤如下所示：
...
这个任务中，点云数据中同时包含了两个物体被叠放在一起，增加了处理的难度。因此，这个任务被分为两部分，一部分专注于三棱柱的提取，另一部分专注于半圆柱的提取。
